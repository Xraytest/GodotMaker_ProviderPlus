...
Tools live at `tools/`. Run from the project root.
...
```bash
python3 tools/find_loop_frame.py assets/video/knight_walk_frames/
```
...
```bash
python3 tools/asset_gen.py set_budget 500
```
