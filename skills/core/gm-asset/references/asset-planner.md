...
Read the **Art direction** from `ASSETS.md` (written during `/gm-gdd`). Use it as context when crafting each asset prompt — but do NOT mechanically prepend it. Different asset types need different prompting:
