...
Generate a reference image of what the finished game looks like. Anchors art direction for the asset planner and implementation workers. The lead agent uses this image for visual QA verification at the end of the pipeline.
